...
Honest strongest claim: `Infer unseen fixtures and environmental supports from action resistance patterns.` is a plausible branch-structured mechanism for tool use and manipulation, supported by synthetic multi-seed diagnostic evidence and hostile-prior-work-aware positioning.
